...
exports.init = function(configDirectoryPath, callback)
{
	...
	var loadContext = function()
	{
        ...
        loadPages(path.join(configDirectoryPath, "pages"), "", context);
        loadBlocks(path.join(configDirectoryPath, "blocks"), context);
...
var compilePage = function(context, pageKey)
{
	...
	if (pageObj["extends"])
	{
		var parentObj = compilePage(context, pageObj["extends"]);
		merge(parentObj, obj);
	}
