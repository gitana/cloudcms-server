                            ...
                            if (req.virtualHost && req.virtualHostDirectoryPath)
                            {
                                ...
                                if (fs.existsSync(gitanaJsonPath))
                                {
                                    ...
                                    if (isVirtual)
                                    {
                                        ...
                                        console.log("---------------------------");
                                        console.log("---------------------------");
                                        console.log("Copy from: " + gitanaJsonPath);
                                        console.log("Copy to: " + gitanaJsonPath + ".backup-" + new Date().getTime());
                                        console.log("---------------------------");
                                        console.log("---------------------------");
                                        console.log("---------------------------");
                                        util.copyFile(gitanaJsonPath, gitanaJsonPath + ".backup-" + new Date().getTime());
