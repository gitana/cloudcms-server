        ...
        return function(req, res, next)
        {
            ...
            if (gitana)
            {
                ...
                if (previewPath || previewNode)
                {
                    ...
                    cloudcmsUtil.preview(host, gitana, repositoryId, branchId, nodeId, nodePath, locale, previewId, size, mimetype, forceReload, filename, function(err, filePath, cacheInfo) {
