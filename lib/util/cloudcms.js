...
exports = module.exports = function(basePath)
{
     ...
     * @param callback
     */
    var downloadPreview = function(host, gitana, repositoryId, branchId, nodeId, locale, previewId, size, forceReload, callback)
    {
        // base storage directory
        ensureContentDirectory(host, repositoryId, branchId, nodeId, locale, function(err, contentDirectoryPath) {
    ...
    r.downloadPreview = function(host, gitana, repositoryId, branchId, nodeId, locale, previewId, size, forceReload, callback)
    {
        downloadPreview(host, gitana, repositoryId, branchId, nodeId, locale, previewId, size, forceReload, callback);
    };
