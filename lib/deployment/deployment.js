...
exports = module.exports = function(basePath)
{
    ...
    {
        console.log("WRITE GITANA CONFIGURATION");
        console.log("DESCRIPTOR: " + JSON.stringify(descriptor, null, "  "));
        ...
        if (fs.existsSync(path.join(hostDirectoryPath, "gitana.json")))
        {
            console.log("DELETE");
            fs.unlinkSync(path.join(hostDirectoryPath, "gitana.json"));
        }
