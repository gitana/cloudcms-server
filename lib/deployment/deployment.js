...
exports = module.exports = function(basePath)
{
    ...
    var doHandleWriteGitanaConfiguration = function(descriptor, hostDirectoryPath, callback)
    {
        ...
        /*
        var gitanaDirectoryPath = path.join(hostDirectoryPath, "gitana");
        util.mkdirs(gitanaDirectoryPath, function(err) {
            ...
            fs.writeFile(path.join(gitanaDirectoryPath, "gitana.json"), JSON.stringify(json, null, "  "), function(err) {
